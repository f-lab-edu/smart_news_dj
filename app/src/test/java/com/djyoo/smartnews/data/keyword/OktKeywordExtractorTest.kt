...
class OktKeywordExtractorTest {
    ...
    @Test
    fun givenEmptyTitleAndDescription_whenExtract_thenReturnsEmptyList() = runTest {
    ...
    @Test
    fun givenWhitespaceOnlyTitleAndDescription_whenExtract_thenReturnsEmptyList() = runTest {
        val expected = emptyList<String>()
    ...
    @Test
    fun givenKoreanTitleAndDescription_whenExtract_thenSatisfiesPipelineContract() = runTest {
        val actual =
            extractor.extract(
